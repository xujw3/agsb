...
# ====== 全局可配置参数（可直接在此处修改） ======
USER_NAME = "kingxujw"         # 用户名
UUID = "0b8d6f00-fabd-45b9-a319-95375ad1d493"                     # UUID，留空则自动生成
PORT = 10086                   # Vmess端口，留空或0则自动生成
DOMAIN = "vless.kingxx.ggff.net"                   # 域名，留空则自动获取
CF_TOKEN = "eyJhIjoiNDJlN2NiYTIxNmY2YWI5NzEzZDQyODUyMWYzM2ZiNTEiLCJ0IjoiN2ViMmM5YjAtMzAzZS00MDBkLTk2MTEtZjhhN2IwMmFlN2M3IiwicyI6IlkyRXpZVGhsWm1ZdFpUY3dNUzAwWTJVMExXRmxZbVV0T1RrNU1EY3lNVE15TjJOaCJ9"                 # Cloudflare Token，留空则用Quick Tunnel
# =========================================
